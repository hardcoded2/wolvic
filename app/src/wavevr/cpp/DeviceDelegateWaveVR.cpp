...
struct DeviceDelegateWaveVR::State {
  ...
  void UpdateControllers() {
    ...
    for (Controller& controller: controllers) {
      ...
      const bool touchpadPressed = false;//WVR_GetInputButtonState(controller.type, WVR_InputId_Alias1_Touchpad);
      const bool touchpadTouched = false;//WVR_GetInputTouchState(controller.type, WVR_InputId_Alias1_Touchpad);
