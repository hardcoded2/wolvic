...
public class RuntimeImpl implements WRuntime {
    ...
    public CrashReportIntent getCrashReportIntent() {
        return new CrashReportIntent(GeckoRuntime.ACTION_CRASHED, GeckoRuntime.EXTRA_MINIDUMP_PATH, GeckoRuntime.EXTRA_EXTRAS_PATH, "processType"); //GeckoRuntime.EXTRA_CRASH_PROCESS_TYPE
    }
